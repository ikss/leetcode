...
class LastDayWhereYouCanStillCrossTest {
    ...
    fun test1UFonWater() {
        ...
        assertEquals(expected, LastDayWhereYouCanStillCross.latestDayToCrossUFonWater(row, col, cells))
    }
    ...
    fun test1UFonLand() {
        ...
        assertEquals(expected, LastDayWhereYouCanStillCross.latestDayToCrossUFonLand(row, col, cells))
    }
