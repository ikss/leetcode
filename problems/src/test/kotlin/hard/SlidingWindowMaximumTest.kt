...
class SlidingWindowMaximumTest {
    ...
    fun test1priorityQueue() {
        ...
        assertArrayEquals(expected, SlidingWindowMaximum.maxSlidingWindowPriorityQueue(nums, k))
    }
    ...
    fun test1indexDeque() {
        ...
        assertArrayEquals(expected, SlidingWindowMaximum.maxSlidingWindowIndexDeque(nums, k))
    }
