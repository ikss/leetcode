 ...
 * its path. For all cells (r, c) traversed on the path, `grid[r][c]` is set to 0. Then, the second robot moves
 ...
 * wants to maximize the number of points it collects. If both robots play optimally, return the number
...
object GridGame {
    fun gridGame(grid: Array<IntArray>): Long {
        ...
        for (turnIndex in grid[0].indices) {
            ...
            result = minOf(result, maxOf(firstRowSum, secondRowSum))
