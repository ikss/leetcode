 ...
 *
 * The positions of each robot are unique. The positions of each factory are also unique. Note that a robot can be in
 * the same position as a factory initially.
 *
